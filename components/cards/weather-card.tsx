...
export function WeatherCard({ data }: WeatherCardProps) {
  ...
  return (
    <div
      className={`w-full max-w-sm ${theme.bg} ${theme.border} border rounded-2xl shadow-sm dark:shadow-gray-900/20 hover:shadow-md dark:hover:shadow-gray-900/30 transition-all duration-200`}
    >
      {/* Header Section */}
      <div className={`${theme.accent} px-6 py-5 rounded-t-2xl`}>
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-600 dark:text-gray-300 capitalize mt-0.5">
              {data.condition}
            </p>
          </div>
      ...
      <div className="px-6 py-6">
        {/* Temperature */}
        <div className="mb-6">
          <span className="text-4xl font-light text-slate-900 dark:text-gray-100">
            {data.temperature}°
          </span>
        </div>
